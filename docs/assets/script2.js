// SONAR POKOJOWY - JavaScript (MAPA FIX — wariant canvas)
// Identyczna logika i filtry jak assets/script.js, ale pinezki rysowane są
// na JEDNYM elemencie <canvas> (L.canvas) zamiast ~1000 węzłów DOM (divIcon).
// Efekt: płynny pan/zoom i filtrowanie przy dużej liczbie ofert, BEZ klastrowania.
// Kształty (kropla / kwadrat), kolory cen, badge N / ↓↑ / × zachowane 1:1.
